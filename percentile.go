...
func percentile(h []row, p int) float64 {
	var p_ix float64
...
func main() {
	...
	*/
	...
	hist = append(hist, row{time: 85, count: 1, total: 85})
	hist = append(hist, row{time: 34, count: 1, total: 34})
	hist = append(hist, row{time: 42, count: 1, total: 42})
	hist = append(hist, row{time: 51, count: 1, total: 51})
	hist = append(hist, row{time: 84, count: 1, total: 84})
	hist = append(hist, row{time: 86, count: 1, total: 86})
	hist = append(hist, row{time: 78, count: 1, total: 78})
	hist = append(hist, row{time: 85, count: 1, total: 85})
	hist = append(hist, row{time: 87, count: 1, total: 87})
	hist = append(hist, row{time: 69, count: 1, total: 69})
	hist = append(hist, row{time: 94, count: 1, total: 94})
	hist = append(hist, row{time: 74, count: 1, total: 74})
	hist = append(hist, row{time: 65, count: 1, total: 65})
	hist = append(hist, row{time: 56, count: 1, total: 56})
	hist = append(hist, row{time: 97, count: 1, total: 97})
	/*
